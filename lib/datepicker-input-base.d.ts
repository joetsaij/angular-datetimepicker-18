...
export declare abstract class NgxMatDatepickerInputBase<S, D = NgxExtractDateTypeFromSelection<S>> implements ControlValueAccessor, AfterViewInit, OnChanges, OnDestroy, Validator {
    ...
    readonly dateChange: import("@angular/core").OutputEmitterRef<NgxMatDatepickerInputEvent<D, S>>;
    /** Emits when an `input` event is fired on this `<input>`. */
    readonly dateInput: import("@angular/core").OutputEmitterRef<NgxMatDatepickerInputEvent<D, S>>;
