...
export declare class NgxMatStartDate<D> extends _NgxMatDateRangeInputBase<D> implements CanUpdateErrorState {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxMatStartDate<any>, "input[ngxMatStartDate]", never, { "errorStateMatcher": { "alias": "errorStateMatcher"; "required": false; }; }, { "dateChange": "dateChange"; "dateInput": "dateInput"; }, never, never, true, never>;
}
...
export declare class NgxMatEndDate<D> extends _NgxMatDateRangeInputBase<D> implements CanUpdateErrorState {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxMatEndDate<any>, "input[ngxMatEndDate]", never, { "errorStateMatcher": { "alias": "errorStateMatcher"; "required": false; }; }, { "dateChange": "dateChange"; "dateInput": "dateInput"; }, never, never, true, never>;
}
export {};
