...
export declare class NgxMatDateRangeInput<D> implements MatFormFieldControl<NgxDateRange<D>>, NgxMatDatepickerControl<D>, NgxMatDateRangeInputParent<D>, NgxMatDateRangePickerInput<D>, AfterContentInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgxMatDateRangeInput<any>, "ngx-mat-date-range-input", ["ngxMatDateRangeInput"], { "rangePicker": { "alias": "rangePicker"; "required": false; }; "required": { "alias": "required"; "required": false; }; "dateFilter": { "alias": "dateFilter"; "required": false; }; "min": { "alias": "min"; "required": false; }; "max": { "alias": "max"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; "separator": { "alias": "separator"; "required": false; }; "comparisonStart": { "alias": "comparisonStart"; "required": false; }; "comparisonEnd": { "alias": "comparisonEnd"; "required": false; }; }, {}, ["_startInput", "_endInput"], ["input[matStartDate]", "input[matEndDate]"], true, never>;
}
