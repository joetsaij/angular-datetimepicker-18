...
export declare class NgxMatDatepickerApply {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxMatDatepickerApply, "[ngxMatDatepickerApply], [ngxMatDateRangePickerApply]", never, {}, {}, never, never, true, never>;
}
...
export declare class NgxMatDatepickerCancel {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxMatDatepickerCancel, "[ngxMatDatepickerCancel], [ngxMatDateRangePickerCancel]", never, {}, {}, never, never, true, never>;
}
/**
...
export declare class NgxMatDatepickerActions implements AfterViewInit, OnDestroy {
    ...
    _template: import("@angular/core").Signal<TemplateRef<unknown>>;
    private _portal;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgxMatDatepickerActions, "ngx-mat-datepicker-actions, ngx-mat-date-range-picker-actions", never, {}, {}, never, ["*"], true, never>;
}
